    ...
    <section className="px-8 py-20">
      <div className="container max-w-6xl mx-auto">
        <div className="text-center">
          ...
          >
           Utilizamos herramientas tecnológicas de última generación, procesos de cobranzas ágiles, flexibles y eficientes, combinados con estrategias customizadas a las necesidades de nuestros clientes, con el foco de optimizar la recuperación, disminuir el costo por riesgo, sin afectar la relación con sus clientes.
          </Typography>
        </div>
