    ...
    <section className="px-10 !py-20">
      <div className="container mx-auto">
        <div className="mb-20 flex w-full flex-col items-center">
          ...
          >
            , contamos con las herramientas enfocadas al analisis de la información, cuyo resultado permite agilizar la toma de desiciones, mejorar los resultados y la eficiencia de la gestión de cobranzas.
          </Typography>
        </div>
